 ...
 */
export function getchib(ns) {
    const ret = wasm.getchib(ns);
    return ret;
}

function __wbg_adapter_26(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hd49f6d75124ac76d(arg0, arg1);
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('chibiwasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
